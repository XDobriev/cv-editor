...
(function (root) {
  ...
  const RESUME_DATA = {
    ...
    about: 'Строю веб-продукты от прототипа до продакшна. Запустил AvtorStudio — SaaS-платформу для писателей, которая работает и собирает фидбек реальных пользователей. На курорте Армхи автоматизировал бизнес-процессы: −10 мин ожидания гостей, −90% нагрузки колл-центра. Преподаю фронтенд — умею объяснять сложное просто.',
    tech: [
